          ...
          <div key={groupIndex} className="relative mb-8">
            ...
            <div className="pl-4 md:pl-6">
              ...
              {dateGroup.events.map((event, eventIndex) => (
                ...
                <Card
                  key={eventIndex}
                  className="mb-4 flex flex-col-reverse justify-between gap-3 rounded-lg border border-dark-500 bg-dark-900 p-3 text-card-foreground shadow-sm md:h-auto md:min-h-[190px] md:flex-row"
                >
